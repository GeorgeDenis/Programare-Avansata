...
public class Main {
    public static void main(String[] args) {
        ...
        Location Brasov = new Location("Iasi",LocationType.CITY,45.65,25.60);
        Location Ploiesti = new Location("Iasi",LocationType.CITY,44.93,26.03);
        Location Bucuresti = new Location("Iasi",LocationType.CITY,90.30,29.93);
