...
public class Main {
    public static void main(String[] args) throws Exception {
        File file = new File("H:/Facultate/Programare-Avansata-main/Laborator 12/TestClass/TestClass/target/classes/org/example/TestClass.class");

        File rootDir = new File("H:/Facultate/Programare-Avansata-main/Laborator 12/TestClass/TestClass/target/classes/");
